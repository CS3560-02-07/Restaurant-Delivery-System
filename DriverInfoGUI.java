...
public class DriverInfoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        driverOptionTabs.addTab("Pickup Confirmation", pickUpConfirm); // names the tab "pick-up confirmation"
        ...
        pendingOrderTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Restaurant", "Order #", "Customer", "Address", "Phone #"
                }));
        ...
        pendingOrdersLayout.setHorizontalGroup(
                pendingOrdersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pendingOrdersLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(pendingOrderScrollPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 631,
                                        Short.MAX_VALUE)
                                .addContainerGap()));
                ...
                pendingOrdersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                pendingOrdersLayout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(pendingOrderScrollPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                305, Short.MAX_VALUE)
                                        .addContainerGap()));
        ...
        /*
         * pendingOrders.setBackground(new java.awt.Color(199, 234, 245)); //set
         * background color of pending order tab
         * 
         ...
         * javax.swing.GroupLayout pendingOrdersLayout = new
         * javax.swing.GroupLayout(pendingOrders);
         * pendingOrders.setLayout(pendingOrdersLayout);
         * pendingOrdersLayout.setHorizontalGroup(
         * pendingOrdersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.
         * LEADING)
         * .addGroup(pendingOrdersLayout.createSequentialGroup()
         * .addContainerGap()
         * .addComponent(pendingOrderScrollPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
